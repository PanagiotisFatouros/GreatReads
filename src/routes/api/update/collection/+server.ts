    ...
    try {
        ...
        if (existingPrismaCollection != null){
            updatedPrismaCollection = await prismaClient.prismaCollection.update({
                ...
                data:{
                    title: title? title: existingPrismaCollection.title,
                    isPublic: isPublic? isPublic: existingPrismaCollection.isPublic,
                    upvotes: upvotes? upvotes: existingPrismaCollection.upvotes
                }
            })
