...
<div class="mt-6 mx-8">
	<div class="flex items-center space-x-3">
		<p class="text-primary-3 text-heading2 font-heading flex items-center">My Library</p>
	...
	<div class="flex justify-center">
		<button
			...
			class="std_button bg-secondary w-36 h-8 rounded-full text-white text-center font-body"
			>View All</button
		>
	</div>
</div>
...
<div class="mt-6 mx-8 mb-3">
	<p class="text-primary-3 text-heading2 font-heading flex items-center">My Notes</p>
