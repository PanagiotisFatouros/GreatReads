...
<div id="navBar" class="bg-primary-3 w-full h-14  flex justify-between content-center m-0">
	...
	<div id="rightNav" class="bg-primary-3 flex justify-around content-center space-x-2">
		<ul class="flex justify-around">
			<li
				class="hover:bg-hover-primary-3 list-none flex justify-center items-center text-primary-1 font-heading text-lg"
			>
				<a href="/library" class=" w-full h-full px-3 flex justify-center items-center"
					>My Library</a
				>
			</li>
		</ul>
		...
		<div class=" h-full inline-block float-right group">
			...
			<div
				class=" absolute right-0 hidden group-hover:block font-body bg-primary-3 shadow-lg text-white self-start"
				id="dropdown-content"
			>
