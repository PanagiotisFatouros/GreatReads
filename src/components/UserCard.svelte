...
<div
	...
	class="w-40 h-52 m-4 flex flex-col justify-center items-center cursor-pointer bg-primary-1 rounded-2xl shadow-lg overflow-hidden"
>
	...
	<p class="w-36 text-secondary font-heading text-body1 font-bold break-normal text-center">
		{user.name}
	</p>
</div>
