...
>
	...
	<div class=" mt-3 self-end space-x-2">
		<button on:click={handleCancel} class="btn bg-primary-1 rounded-full px-3 py-0.5"><p>Cancel</p></button
		>
		<button on:click={handleConfirm} class="btn bg-accent text-white rounded-full px-3 py-0.5"
			><p>Confirm</p></button
		>
	</div>
</div>
