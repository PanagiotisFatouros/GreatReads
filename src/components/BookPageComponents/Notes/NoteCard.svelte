...
{#if edittingNote}
<div class="fixed bg-white rounded-2xl z-10 w-114 pt-1 pb-4 px-4 top-1/2 left-1/2 " id='noteInput'>
	<NoteInput note={note} on:cancel={() => closeEditInput()} on:update={() => closeEditInput(true)} />
</div>
